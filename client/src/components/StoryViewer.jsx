...
const StoryViewer = ({viewStory, setViewStory}) => {
  ...
  return (
    <div className='fixed inset-0 h-screen bg-black bg-opacity-90 z-110 flex items-center justify-center' style={{backgroundColor: viewStory.media_type===
        ...
        <div className='absolute top-4 left-4 flex items-center space-x-3 p-2 px-4 sm:p-4 sm:px-8 backdrop-blur-2xl rounded bg-black/50'>
            ...
            <div className='text-white fon-medium flex items-center gap-1.5'>
